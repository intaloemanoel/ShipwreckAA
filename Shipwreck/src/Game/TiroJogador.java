...
public class TiroJogador extends javax.swing.JFrame {
    ...
    public void setPorta(int Porta) {
     ...
     private int limiteSub=0, limiteNav=0, limiteCa=0, limitePorta=0,bloqueio=0;
    ...
    public int getLimitePorta() {
     ...
     public void VerificandoCor(JButton botao){
       
        if((botao.getBackground()!= color)){  
     ...
     public void VerificandoCor(JButton botao,JButton botao1){
       
        if((botao.getBackground()!= color && botao1.getBackground()!= color)){  
                
            botao.setBackground(color);
            botao1.setBackground(color);
           this.setlimiteNav(1);
            this.setBloqueio(1);

        }
        else{
            JOptionPane.showMessageDialog(null,"Escolh novamente um lugar para o tiro" );
             this.setlimiteNav(0);
             this.setBloqueio(0);
        }
    }
     
      public void VerificandoCor(JButton botao, JButton botao1, JButton botao2, JButton botao3,JButton  botao4){
       
        if((botao.getBackground()!= color && botao1.getBackground()!= color  && botao2.getBackground()!= color && botao3.getBackground()!= color && botao4.getBackground()!= color)){
               
            botao.setBackground(color);
            botao1.setBackground(color);
            botao2.setBackground(color);
            botao3.setBackground(color);
            botao3.setBackground(color);
            botao4.setBackground(color);
    ...
    private void A1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_A1ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0 && this.getBloqueio()==0){ 
                    
           VerificandoCor(A1); 
        }
        else if(nav==2 && this.getLimiteNav()==0 && this.getBloqueio()==0 && this.getBloqueio()==0){
           
          VerificandoCor(A1,A2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
              VerificandoCor(A1,A2,A0,B1,botao);
        }
// TODO add your handling code here:A1.setBackground(color);
    ...
    private void A3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_A3ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
                    
           VerificandoCor(A3); 
        }
        else if(nav==2 && this.getLimiteNav()==0 && this.getBloqueio()==0){
           
          VerificandoCor(A3,A2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(A3,A2,A4,B3,botao); 
        }
    ...
    private void B9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B9ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(B9,B8);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(B9,B8,A9,C9,botao); 
        }
    ...
    private void C0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_C0ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(C0,C1);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
               VerificandoCor(C0,C1,D0,B0,botao);  
        }
    ...
    private void C1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_C1ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(C1,C2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(C1,C2,C0,D1,B1); 
        }
    ...
    private void C2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_C2ActionPerformed
      int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(C2,C3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(C2,C3,C1,D2,B2);
        }
    ...
    private void C3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_C3ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(C3,C2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(C3,C2,B3,C4,D3); 
        }
    ...
    private void C4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_C4ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(C4,C3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(C4,C3,B4,C5,D4); 
        }
    ...
    private void C5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_C5ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(C5,C4);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
              VerificandoCor(C5,C4,D5,B5,C6); 
        }
    ...
    private void C6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_C6ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(C6,C5);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(C6,C5,C7,D6,B6); 
        }
...
// TODO add your handling code here: C7.setBackground(color); // TODO add your handling code here:
    ...
    private void C8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_C8ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(C6,C8);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(C8,C7,D8,B8,C9); 
        }
    ...
    private void C9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_C9ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(C9,C8);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(C9,C8,D9,B9,botao); 
        }
    ...
    private void J2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_J2ActionPerformed
      int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(J2,J3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(J2,J3,I3,J4,botao);  
        }
    ...
    private void D0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_D0ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(D0,D1);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(D0,D1,E0,C0,botao);  
        }
...
int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(D1,D2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(D1,D2,D0,E1,C1);
        }
...
int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(D2,D3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(D2,D3,D1,E2,C2);
        }
...
int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(D3,D2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(D3,D2,D4,E3,C3); 
        }
...
int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(D4,D3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(D4,D3,D5,E4,C4);  
        }
...
int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(D5,D4);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(D5,D4,E5,D6,C5);
        }
...
int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(D6,D5);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(D6,D5,D7,E6,C6); 
        }
...
int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(D5,D6);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(D7,D6,D8,E7,C7); 
        }
...
int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(D9,D8);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
              VerificandoCor(D9,D8,E9,C9,botao);
        }
       // TODO add your handling code here:
    ...
    private void E0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_E0ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(E0,E1);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(E0,E1,D0,F0,E1); 
        }
       // TODO add your handling code here:
    ...
    private void E1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_E1ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(E1,E2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
              VerificandoCor(E1,E2,E0,F1,D1); 
        }
        // TODO add your handling code here:
    ...
    private void E2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_E2ActionPerformed
      int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(E2,E3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(E2,E3,E4,F3,D3); 
        }
       // TODO add your handling code here:
    ...
    private void E3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_E3ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(E3,E2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(E3,E2,F3,E4,D3);
        }
        // TODO add your handling code here:
...
int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(E4,E3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(E4,E3,F4,D4,E5);
        }
        // TODO add your handling code here:
...
int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(E5,E4);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(E5,E4,F5,E6,D5); 
        }
       // TODO add your handling code here:
    ...
    private void E6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_E6ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(E6,E5);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(E6,E5,E7,F6,D6); 
        }
        // TODO add your handling code here:
    ...
    private void E8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_E8ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(E6,E8);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
              VerificandoCor(E7,E8,E9,F8,D8); 
        }
    ...
    private void E9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_E9ActionPerformed
      int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(E9,E8);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(E9,E8,D9,F9,botao); 
        }
        // TODO add your handling code here:
    ...
    private void F0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_F0ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(F0,F1);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(F0,F1,E0,G0,botao); 
        }
// TODO add your handling code here:// TODO add your handling code here:
    ...
    private void F1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_F1ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(F1,F2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(F1,F2,F0,G1,E1); 
        }
    ...
    private void F2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_F2ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(F2,F3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
              VerificandoCor(F2,F3,F1,E2,G2);
        }
        // TODO add your handling code here:// TODO add your handling code here:
    ...
    private void F3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_F3ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(F3,F2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
                       VerificandoCor(F3,F2,F4,G3,E3); 
        }
        // TODO add your handling code here:// TODO add your handling code here:
    ...
    private void F4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_F4ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(F4,F3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(F4,F3,F5,G4,E4);
        }
        // TODO add your handling code here: // TODO add your handling code here:
    ...
    private void F5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_F5ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(F5,F4);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(F5,F4,E5,G5,F6); 
        }
        // TODO add your handling code here:// TODO add your handling code here:
    ...
    private void F6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_F6ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(F6,F5);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(F6,F5,E6,G6,F7); 
        }
// TODO add your handling code here:// TODO add your handling code here:
    ...
    private void F7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_F7ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(F5,F6);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
              VerificandoCor(F7,F6,F8,G7,E7); 
        }
        // TODO add your handling code here:// TODO add your handling code here:
    ...
    private void F8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_F8ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(F6,F8);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
              VerificandoCor(F7,F8,F9,G8,E8); 
        }
        // TODO add your handling code here:// TODO add your handling code here:
    ...
    private void F9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_F9ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(F9,F8);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
              VerificandoCor(F9,F8,E9,G9,botao);  
        }
        // TODO add your handling code here:
// TODO add your handling code here:
    ...
    private void G0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G0ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(G0,G1);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(F9,G9,F8,E9,botao); 
        }
    ...
    private void G1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G1ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(G1,G2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(G1,G2,G0,H1,F1); 
        }
    ...
    private void G2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G2ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(G2,G3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(G2,G3,G1,H2,F2); 
        }
    ...
    private void G3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G3ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(G3,G2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(G3,G2,G4,H3,F3);  
        }
...
// TODO add your handling code here:
    ...
    private void G4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G4ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(G4,G5);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(G4,G3,G5,H4,F4);  
        }
    ...
    private void G5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G5ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(G5,G4);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(G5,G4,G6,H5,F5); 
        }
    ...
    private void G6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G6ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(G6,G7);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(G5,G6,F6,G7,H6); 
        }
...
// TODO add your handling code here:
 ...
 int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(G7,G8);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(G6,G7,G8,F7,H7); 
        }
        // TODO add your handling code here:
    ...
    private void G8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G8ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(G8,G9);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(G8,G7,G9,H8,F8);
        }
...
// TODO add your handling code here:
    ...
    private void G9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G9ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(G9,G8);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(G9,G8,H9,F9,botao); 
        }
    ...
    private void H0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_H0ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(H0,H1);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(H0,H1,I0,G0,botao);  
        }
    ...
    private void H1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_H1ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(H1,H2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(H1,H2,H0,I1,G1); 
        }
    ...
    private void H2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_H2ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(H2,H3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(H2,H3,H1,I2,G2); 
        }
    ...
    private void H3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_H3ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(H3,H2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(H3,H2,H4,I3,G3);  
        }
    ...
    private void H4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_H4ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(H3,H4);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(H4,H3,H5,I4,G4);  
        }
    ...
    private void H5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_H5ActionPerformed
      int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(H5,H4);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(H4,H5,H6,I5,G5);
        }
    ...
    private void H6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_H6ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(H6,H5);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(H6,H5,H7,G6,I6); 
        }
    ...
    private void H7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_H7ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(H7,H6);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(H7,H6,H8,I7,G7);
        }
    ...
    private void H8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_H8ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(H8,H7);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(H8,H7,H9,I8,G8);  
        }
    ...
    private void H9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_H9ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(H9,H8);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
         VerificandoCor(H9,H8,I9,G9,botao); 
        }
    ...
    private void I0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_I0ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(I0,I1);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
           VerificandoCor(I0,I1,H0,J0,botao); 
        }
    ...
    private void I1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_I1ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(I1,I2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(I1,I2,I3,J3,H3); 
        }
// TODO add your handling code here:
    ...
    private void I2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_I2ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(I2,I3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(I2,I3,I4,J3,H3);  
        }
    ...
    private void I3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_I3ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(I3,I2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(I3,I2,I4,J3,H3); 
        }
    ...
    private void I4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_I4ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(I4,I3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(I4,I3,I5,J4,H4);  
        }
    ...
    private void I5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_I5ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(I5,I4);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(I4,I5,I6,J5,H5);  
        }
    ...
    private void I6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_I6ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(I6,I5);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(I6,I5,I4,J5,H5); 
        }
    ...
    private void I7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_I7ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(I6,I7);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
              VerificandoCor(I7,I6,I8,J7,H7); 
        }
    ...
    private void I8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_I8ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(I8,I7);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
              VerificandoCor(I9,I8,J8,H8,I7); 
        }
    ...
    private void I9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_I9ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
            ...
            VerificandoCor(I9,I8); 
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            
            VerificandoCor(I9,I8,H9,J9,botao);   
        }
    ...
    private void J0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_J0ActionPerformed
     int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
           ...
           VerificandoCor(J0,J1); 
            
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
                         VerificandoCor(J0,J1,I0,botao,botao);    
        }
    ...
    private void J1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_J1ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
            ...
            VerificandoCor(J1,J2); 
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(J1,J2,J0,I1,botao);   
        }
    ...
    private void J3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_J3ActionPerformed
      int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
           ...
           VerificandoCor(J3,J2);
            
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            
              VerificandoCor(J2,J3,J5,I4,botao);  
        }
    ...
    private void J4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_J4ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
           ...
           VerificandoCor(J4,J3);
            
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             
            VerificandoCor(J4,J3,J5,I5,botao);  
        }
       ...
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
            ...
            VerificandoCor(J5);
             ...
             VerificandoCor(J5,J4); 
            
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            
             VerificandoCor(J5,J4,I5,J6,botao);
        }
    ...
    private void J6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_J6ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(J6);  
            ...
            VerificandoCor(J5,J6); 
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
          VerificandoCor(J6,J5,J7,I6,botao);   
        }
    ...
    private void J7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_J7ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
            ...
            VerificandoCor(J7,J6); 
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            
            VerificandoCor(J6,J7,J8,I7,botao); 
        }
    ...
    private void J8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_J8ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(J8);  
            ...
            VerificandoCor(J8,J7);
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             
               VerificandoCor(J8,J7,J9,I9,botao);   
        }
    ...
    private void J9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_J9ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
            ...
            VerificandoCor(J9,J8); 
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            
             VerificandoCor(J9,J8,I9,botao,botao);
        }
    ...
    private void A0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_A0ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(A0,A1);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(A0,A1,B0,botao,botao);
        }
 // TODO add your handling code here:
    ...
    private void A2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_A2ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(A2,A3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(A2,A3,A1,B2,botao);
        }
    ...
    private void A4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_A4ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(A4,A3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(A4,A3,A5,B4,botao); 
        }
        // TODO add your handling code here:
    ...
    private void A5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_A5ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(A5,A4);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(A5,A4,A6,B5,botao);
        }
        // TODO add your handling code here:
    ...
    private void A6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_A6ActionPerformed
       int sub= this.getSub();
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(A6,A5);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(A6,A5,A7,B6,botao); 
        }
         // TODO add your handling code here:
    ...
    private void A7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_A7ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(A7,A6);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(A7,A6,A8,B7,botao);  
        }
        // TODO add your handling code here:
    ...
    private void A8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_A8ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(A8,A7);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(A8,A7,A9,B8,botao);
        }
       // TODO add your handling code here:
    ...
    private void A9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_A9ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(A9,A8);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(A9,A8,B9,botao,botao);  
        }
        // TODO add your handling code here:
    ...
    private void B0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B0ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(B0,B1);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(B0,B1,A0,C0,botao);  
        }
        //  TODO add your handling code here:
    ...
    private void B1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B1ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(B1,B2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(B2,B1,B0,C1,A1); 
    ...
    private void B2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B2ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(B2,B3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(B2,B3,B4,C2,A2); 
        }
        // TODO add your handling code here:
    ...
    private void B3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B3ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(B3,B2);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(B3,B2,B4,C4,A4);
        }
                  // TODO add your handling code here:
    ...
    private void B4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B4ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(B4,B3);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(B4,B3,B5,C4,A4); 
        }
        // TODO add your handling code here:
    ...
    private void B5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B5ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(B5,B4);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(B5,B4,B6,C5,A5);
        }
        // TODO add your handling code here:
    ...
    private void B6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B6ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(B6,B5);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
            VerificandoCor(B6,B5,B7,C6,A6);
        }
        // TODO add your handling code here:
    ...
    private void B7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B7ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(B7,B6);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
             VerificandoCor(B7,A8,B8,C8,B9); 
        }
       // TODO add your handling code here:
    ...
    private void B8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B8ActionPerformed
        ...
        if(sub==1 && this.getLimiteSub()==0 && this.getBloqueio()==0){ 
          ...
          VerificandoCor(B8,B7);   
        }
        else if(ca==3 && this.getLimiteCa()==0 && this.getBloqueio()==0){
           VerificandoCor(B8,B7,B9,C8,A8); 
        }
        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TiroJogador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        TiroJogador temp= new TiroJogador();

        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TiroJogador().setVisible(true);
            }
        });
