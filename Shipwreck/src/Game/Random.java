...
public class Random extends javax.swing.JFrame {
    ...
    public void CriandoTelas(){
        ...
        */
        ...
        //Porta Avião cor: Verde num:4
        linhaSorteada =(int) (Math.round(0+(Math.random()*9)));
        colunaSorteada = (int) (Math.round(0+(Math.random()*6)));
        for( j = colunaSorteada; j < colunaSorteada + 4; j++){
            
            botoes[linhaSorteada][j].setBackground(new java.awt.Color(0, 28, 4));
             temp.matriz[linhaSorteada][j]= 4;
        }
        boolean ocupado;
        //Submarino cor: Vermelho num: 3
        do{
            ...
            linhaSorteada =(int) (Math.round(0+(Math.random()*9)));
            colunaSorteada = (int) (Math.round(0+(Math.random()*6)));
            temp.posicaoSubL= linhaSorteada;
            temp.posicaoSubL= colunaSorteada;
            
            
            for( j = colunaSorteada; j < colunaSorteada + 2; j++){
                if(temp.matriz[linhaSorteada][j]!=0){
                    ocupado = true;
                    break;
                }
            }
            ...
            if(!ocupado){
                for(j = colunaSorteada; j < colunaSorteada + 2; j++){
                    botoes[linhaSorteada][j].setBackground(new java.awt.Color(255, 51, 51));
                    temp.matriz[linhaSorteada][j] = 3;
                }
            }
        ...
        do{
            ...
            linhaSorteada =(int) (Math.round(0+(Math.random()*9)));
            colunaSorteada = (int) (Math.round(0+(Math.random()*6)));
            temp.posicaoCacaL= linhaSorteada;
            temp.posicaoCacaC= colunaSorteada;
            ...
            if(!ocupado){
                for(j = colunaSorteada; j < colunaSorteada + 2; j++){
                    botoes[linhaSorteada][j].setBackground(new java.awt.Color(153, 0, 255));
                    temp.matriz[linhaSorteada][j] = 2;

                }
            }
            
        }while(ocupado);
        //Navio de Escolta cor: Laranja num: 1
        do{
            ...
            linhaSorteada =(int) (Math.round(0+(Math.random()*9)));
            colunaSorteada = (int) (Math.round(0+(Math.random()*6)));
            temp.posicaoEscoltaL= linhaSorteada;
            temp.posicaoEscoltaC= colunaSorteada;
            
            
            for( j = colunaSorteada; j < colunaSorteada + 3; j++){
                if((temp.matriz[linhaSorteada][j]!=0)){
                    ocupado = true;
                    break;
                }
            ...
            if(!ocupado){
                for(j = colunaSorteada; j < colunaSorteada + 3; j++){
                    botoes[linhaSorteada][j].setBackground(new java.awt.Color(255, 153, 102));
                    temp.matriz[linhaSorteada][j] = 1;
                }
            }
